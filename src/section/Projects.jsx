  ...
  return (
    <section className='c-space my-20'>
        ...
        <div className='flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl'>
            ...
            <div className='p-3 backdrop:filter backdrop:blur-3xl w-fi rounded-lg style={myProjects[0].logoStyle}'>
                <img src={myProjects} alt="logo" className='w-10 h-10 shadow-sm' />
            </div>
        </div>
